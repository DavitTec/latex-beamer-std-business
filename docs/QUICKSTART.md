...
pnpm install
pnpm compile   #bash ./scripts/compile-latex-prj.sh
```

Or manually:

```bash
cd ./latex-beamer-std-business/src/latex/latex-beamer-bizpres
pdflatex -interaction=nonstopmode -output-directory="./build" "main.tex" 
pdflatex -interaction=nonstopmode -output-directory="./build" "main.tex" 

# Build directory: ./build
# Using LaTeX source: ./src/latex/latex-beamer-bizpres/main.tex
# Output will be saved to: ./build/main.pdf
```
